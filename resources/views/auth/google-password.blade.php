<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{url('/auth/google/password')}}">
            @csrf

            <div>
                <x-jet-label for="password" value="{{ __('Password') }}" />
                <x-jet-input id="password" class="block mt-1 w-full" type="password" name="password" autocomplete="current-password" required />
            </div>
